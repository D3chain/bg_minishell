...
SRCS		=	src/main.c \
				...
				$(PARSDIR)ms_parser.c $(PARSDIR)argvec.c $(PARSDIR)redirvec.c $(PARSDIR)parsecmd.c $(PARSDIR)parsepao.c $(PARSDIR)here_doc.c \
				...
				$(UTILSDIR)join_and_free.c $(UTILSDIR)realloc_array.c $(UTILSDIR)fd.c \
